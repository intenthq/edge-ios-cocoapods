Pod::Spec.new do |s|
    ...
    s.source       = { :http => "https://dl.anagog.com/ios/cocoapods/5.51.5/JedAI-5.51.5.1329.zip" }
    s.swift_version = "5.0"
    s.default_subspec = "Core"

    s.subspec "IntentSwiftProtobuf" do |sp|
        sp.vendored_frameworks="Frameworks/IntentSwiftProtobuf.xcframework"
    end

    s.subspec "Core" do |sp|
        sp.vendored_frameworks="Frameworks/JedAIKit.xcframework"
        sp.dependency "JedAI/IntentSwiftProtobuf"
    end
