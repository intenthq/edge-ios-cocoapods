Pod::Spec.new do |s|
    ...
    s.source       = { :http => "https://dl.anagog.com/ios/cocoapods/5.55.0/JedAI-5.55.0.1477.zip" }
    s.swift_version = "5.0"
    ...
    s.subspec "MCP" do |sp|
        sp.vendored_frameworks="Frameworks/JedAIMCPKit.xcframework"
        sp.dependency "JedAI/Core"
        sp.dependency "JedAI/App"
        sp.dependency "JedAI/JEMA"
        sp.dependency "JedAI/Metrics"
    end
    s.subspec "Internal" do |sp|
        sp.vendored_frameworks="Frameworks/JedAIInternalKit.xcframework"
        sp.dependency "JedAI/Core"
    end
end
